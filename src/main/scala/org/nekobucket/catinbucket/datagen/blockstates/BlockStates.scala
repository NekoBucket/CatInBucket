...
private[datagen] class BlockStates(implicit generator: DataGenerator, implicit val fileHelper: ExistingFileHelper)
...
private[catinbucket] object BlockStates extends DataGenObj[BlockState]